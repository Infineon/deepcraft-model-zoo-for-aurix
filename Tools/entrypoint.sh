#!/bin/bash
# filepath: /home/wsluser/git_repos/tricore-tools-docker/entrypoint.sh
...
case "${MODE}" in
    ...
    "debug")
        ...
        echo "Workspace mounted at: /home/ubuntu/workspace"
        jupyter lab --ip=0.0.0.0 --port=8888 --no-browser --allow-root --NotebookApp.token='' --NotebookApp.password=''
        ;;
    *)
        echo "Unknown mode: ${MODE}. Use 'api' or 'debug'"
        exit 1
        ;;
esac